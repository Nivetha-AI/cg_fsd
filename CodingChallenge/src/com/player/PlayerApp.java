...
public class PlayerApp {
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            System.out.println("4. List all players by experience");
            System.out.println("5. Update player details");
            ...
            switch (choice) {
                ...
                case 4: // List all players by experience
                	 List<Player> playersByExperience = playerOperations.getPlayersByExperience();
                     System.out.println("\nPlayers sorted by experience (most experienced first):");
                     playersByExperience.forEach(p -> System.out.println(p.getId() + " - " + p.getName() + " (Experience: " + p.getExp() + " years)"));
                     break;

                case 5: // Update player details
                    ...
                    List<Player> allPlayersList = playerOperations.getAllPlayers(); // Fetch all players to search by ID
